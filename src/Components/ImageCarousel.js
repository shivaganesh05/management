...
const ImageCarousel = () => {
  ...
  return (
    <div className=''>
      <div class="relative overflow-hidden rounded-lg bg-cover bg-no-repeat  text-center bg-[url('https://demo.createdbycocoon.com/moodle/edumy/15/pluginfile.php/471/block_cocoon_slider_8/slides/1/1.jpg')] h-[500px]  w-full"
>
  <div
